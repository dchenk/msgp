...
// Because many MessagePack implementations by default encode all non-negative integers as unsigned,
// we should be able to decode unsigned integers into Go's signed integers when the integer does
// not overflow.
